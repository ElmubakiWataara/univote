      ...
      <div className="max-w-lg">
        ...
        <div className="bg-white rounded-3xl shadow p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Email (SuperAdmin Login)</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Password for SuperAdmin</label>
              <input
                type="password"
          ...
          {success && <p className="mt-6 text-green-600 font-medium">{success}</p>}
